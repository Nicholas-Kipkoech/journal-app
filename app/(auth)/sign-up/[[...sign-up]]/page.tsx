...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center">
      <div className="flex flex-col md:flex-row  gap-10 md:shadow-xl p-4 rounded-md">
        {/* Image Section */}
        ...
        {/* Form Section */}
        <div className="w-full md:w-1/2 flex flex-col items-center md:bg-gradient-to-b from-[#32a2a8] to-white rounded-md">
          <span className="font-bold text-[1.8rem] my-2">Sign Up</span>

          <div className="flex flex-col gap-4  p-10 rounded-md  w-full max-w-[400px]">
            <div>
